...
export declare function openAddressManager(baseUrl: string, lang: FawryLanguages, merchantInfo: MerchantInfo, customerInfo: CustomerInfo, beid: string, addressHierarchy: AddressHierarchy): Promise<any>;
...
export declare enum AddressHierarchy {
    MATRIX = "MATRIX",
...
export declare class FawryCallbacks {
    ...
    static FAWRY_EVENT_CARD_MANAGER_FAIL: string;
    static FAWRY_EVENT_ADDRESS_MANAGER_FAIL: string;
}
