...
exports.Geolocation = exports.FawryLanguages = exports.FawryCallbacks = exports.Area = exports.AddressType = exports.AddressHierarchy = exports.Address = void 0;
exports.openAddressManager = openAddressManager;
...
async function startPayment(addressHierarchy, allow3DPayment, apiPath, baseUrl, customerInfo, items, lang, merchantInfo, showLoyaltyContainer, showTipsView, showVoucherContainer, skipReceipt, beid, branchCode, branchName, scheduledTime, serviceTypeCode, tableId, shippingAddress) {
  ...
  RnFawryPaySdk.startPayment(baseUrl, lang, addressHierarchy, allow3DPayment, apiPath, customerInfo, items, merchantInfo, showLoyaltyContainer, showTipsView, showVoucherContainer, skipReceipt, optionalParams);
}
...
async function openAddressManager(baseUrl, lang, merchantInfo, customerInfo, beid, addressHierarchy) {
...
let AddressHierarchy = /*#__PURE__*/function (AddressHierarchy) {
  AddressHierarchy["MATRIX"] = "MATRIX";
  AddressHierarchy["GEOLOCATION"] = "GEOLOCATION";
  return AddressHierarchy;
}({});
exports.AddressHierarchy = AddressHierarchy;
class Address {}
