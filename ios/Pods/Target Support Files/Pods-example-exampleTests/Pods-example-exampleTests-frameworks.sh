...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/rn-fawry-pay-sdk/rn_fawry_pay_sdk.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FawryPaySDK-Registered-Testing/FawryFramework.framework"
fi
